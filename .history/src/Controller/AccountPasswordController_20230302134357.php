    ...
    public function index(ManagerRegistry $doctrine, Request $request, UserPasswordEncoderInterface $encoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            if ($encoder->isPasswordValid($user, $old_password)){
                ...
                if ($password_encoder = $encoder->encodePassword($user, $new_password)){
                    ...
                    $notifications = "Votre mot de passe a bien été modifié";
                } else {
                    $notifications = "Votre mot de passe n'a pas pu être modifié";
                }
            }
        }
